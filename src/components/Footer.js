...
const Footer = () => {
  ...
  return (
    <>
      <div className="fixed lg:relative bottom-0 right-0 left-0">
              ...
              <Link href='/cart'>
                <div className="flex flex-col items-center gap-2 justify-center text-xs">
                  <div className="relative">
                    ...
                    <div className="absolute top-0 left-0 translate-x-[80%] -translate-y-1/2 w-4 h-4 rounded-full bg-red-600 text-center text-[8px] text-white">
                      {/* {value?.length} */}0
                    </div>
                  </div>
                  Giỏ hàng
