...
import { BsBoxArrowRight, BsPersonBoundingBox, BsReceipt, BsSearchHeart } from "react-icons/bs";
        ...
        <div className="flex items-center justify-evenly h-full mr-4 max-lg:w-full max-lg:justify-between max-lg:gap-x-3 max-lg:px-6 max-md:px-5 max-sm:px-3">
          ...
          <div className="flex items-center justify-evenly">
            ...
            <div className="dropdown dropdown-end searchIcon mr-5">
              ...
              <div
                tabIndex={0}
                className="shadow dropdown-content bg-base-100 rounded-box z-10"
              >
                <CartIcon>
            ...
            {/* tìm kiếm đơn hàng */}
            <div className="dropdown dropdown-end eysIcon mr-5 z-10">
              <span tabIndex={0}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div
                tabIndex={0}
                className="shadow dropdown-content menu bg-base-100 rounded-box z-10"
              >
            ...
            {/* giỏ hàng */}
            <div className="relative dropdown dropdown-end bagIcon mr-5 z-10">
              <Link href="/cart">
                <span tabIndex={0}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            {token ? (
              <>
                {/* profile */}
                <div className="relative flex items-center justify-between dropdown dropdown-end z-10">
              ...
              <>
                {/* signin - register */}
                <div className="dropdown dropdown-end personIcon z-10">
                  <span tabIndex={0}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
