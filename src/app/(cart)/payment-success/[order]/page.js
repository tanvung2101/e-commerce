...
//   //   },
//   // });
//   const res = await configDataApis.getListPagingConfigData({ params })
...
function PagePaymentSucces() {
  ...
  }, [masterCapacity, masterUnit, searchParams.order]);
  useEffect(() => {
    getCartItemsInfo();
  }, [getCartItemsInfo]);
        ...
        <div className="px-40 mt-10 max-lg:px-20 max-md:px-10">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center gap-1 text-lg font-extralight">
              <span>
                ORDER: <strong>{searchParams.order}</strong>
              </span>
