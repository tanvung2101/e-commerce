        ...
        <div className="flex items-start py-5 px-28 bg-light-pink max-lg:px-8 max-md:flex-col">
          ...
          <div className="w-[40%] flex-col items-center justify-center mt-4 text-black px-4 max-md:w-full max-md:mt-14">
            <div className="max-lg:flex max-lg:flex-col max-lg:items-center">
              {productIt?.name && (
                <h2 className="block mt-4 text-4xl font-bold max-lg:text-center">
                  {productIt?.name}
                </h2>
              )}
              {productIt?.nameVi && (
                <span className="block mt-4 font-sans text-base max-lg:text-center">
                  {productIt?.nameVi}
                </span>
              )}
              {productIt?.acronym && (
              ...
              <span className="block mt-4 text-lg max-lg:text-center">
                Tình trạng:{" "}
                <label className="text-[#8fc83c] font-bold">
            ...
            <div className="flex flex-col max-lg:items-center">
              <p className="font-sans text-xl font-semibold">Số lượng</p>
            ...
            <div className="text-lg text-white uppercase mt-7">
              ...
              >
                {product &&
                  product.productDetailOption?.map((optionCapcity) => {
                    ...
                    return (
                      <div key={optionCapcity.value} className="max-lg:mx-auto">
                        ...
                        />
                        <label
                          className={`inline-block text-center text-base border-[1px] border-red-600 rounded-md py-1 px-2 cursor-pointer ${
                            capacity === optionCapcity.value
            ...
            {detailProductQuantity > 0 && (
              <div className="flex items-start gap-5 mt-5 text-center max-md:items-center max-md:justify-center">
                <button
            ...
            {detailProductQuantity < 10 && detailProductQuantity !== 0 && (
              <div className="mt-3 text-regal-red max-lg:text-center">
          ...
          <div className="flex items-center justify-center py-2 mx-auto mt-5 max-sm:flex-col max-sm:gap-3">
            {introduce.length > 0 &&
              introduce.map((item) => (
                ...
                >
                  <span className="font-sans text-2xl max-md:text-xl">
                    {item.title}
                  </span>
                </div>
              ))}
